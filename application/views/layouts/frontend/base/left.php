...
<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col col_1 left-column sm568Max_width_100">
	<div class="ctn">
		<div class="main_left">
			...
			<!-- Box -->
			<div class="box">
				<h3><i class="fa fa-globe"></i><?php echo mb_strtoupper(lang('msg_thecnologie')) ?></h3>
			...
			<!-- Box -->
			<div class="box">
				<h3><i class="fa fa-leaf"></i><?php echo mb_strtoupper(lang('msg_quizs')) ?></h3>
			...
			<!-- Box -->
			<div class="box">
				<h3><i class="fa fa-share-alt"></i><?php echo mb_strtoupper(lang('msg_follow_us')) ?></h3>
					...
					<?php if(!empty($pages) && count($pages) > 0) : ?>
						...
						<table class="table table-hover table-bordered table-condensed table-striped">
							<tbody>
								<?php foreach ($pages as $key => $value) : ?>
									<tr>
										<td><?php echo mb_strtoupper($value['name']) ?></td>
